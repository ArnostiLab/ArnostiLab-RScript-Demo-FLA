...
outputPath <- "stdbins-gpc2-270720.csv"
#filename want std bin visualization to be, in png format
pngPath <- "stdbins-gpc2-270720.png"
...
#If you look at the StdBins, it gives 900 values rather than just 5, as it should
#trying to get rid of random values:
StdBins[c(1,2,3,4,5), ]
StdBins<-StdBins[c(1,2,3,4,5), ]
