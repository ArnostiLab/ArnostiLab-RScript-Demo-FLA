##To start, put all the files you want to process in one folder. Name it whatever you want, reflected in line 5.Define where you want your .csv files to go in line 7, and your chromatogram folder in line 9 
